...
VERSION="0.2.0"
TAG="v0.2.0-core"
HELPER_SHA256="cbd82e8c26a8546c31bb8a9241b07a1887c34a359b41241b3c7c252a5ee08475"
MANIFEST_SHA256="70e22a5658b3725cf3782f1b1868ee3eaf608741d08c4488086a4c67a19d8a80"
...
wget --timeout=60 --tries=3 -O "$temp/core-manifest.json" "$BASE/releases/core-0.2.0.json"
...
if json.loads(pathlib.Path(sys.argv[1]).read_text()).get('version') != '0.2.0':
    raise SystemExit('Incorrect release manifest')
PY
install -d -m 0755 /usr/local/lib/codynick/core-0.2.0
install -m 0644 "$temp/app_setup.py" /usr/local/lib/codynick/core-0.2.0/app_setup.py
install -m 0644 "$temp/core-manifest.json" /usr/local/lib/codynick/core-0.2.0/core-manifest.json
...
systemd-run --unit=codynick-install --collect --property=Type=exec \
    /usr/bin/python3 -u /usr/local/lib/codynick/core-0.2.0/app_setup.py --worker
echo
...
echo 'Success ends with: CodyNick core 0.2.0: READY'
