...
def main():
    ...
    data = {
        "version": "0.7.1", "tag": "v0.7.1-api-reference", "status": "hardware-trial",
        "components": {"ide": "0.7.1-api-reference", "CodyNick.py": "1.20.1", "Dashboard.py": "image-20260711", "watchdog": "0.2.0", "vision": "0.7.0-camera-cleanup", "examples": "0.7.0", "speech": "0.4.0-image-baseline", "ocr": "0.5.0-image-baseline", "tts": "0.6.1-permissions"},
    ...
    manifest = ROOT / "releases/core-0.7.1.json"
