...
APPS_SHA256="5bd031a127f15c65cf7e2f7f734e6518cd904be7f0972c86c3f0b888a4a0e508"
...
fetch apps.sh https://raw.githubusercontent.com/Sohaware/rpi/v0.6.1-tts-permissions/bootstrap/codynick-apps.sh "$APPS_SHA256"
bash "$temp/apps.sh"
