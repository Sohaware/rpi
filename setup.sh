...
APPS_SHA256="ebb83585afe0fbe6032f693d155666b487412def098dc52223ec4b77f720937a"
...
fetch apps.sh https://raw.githubusercontent.com/Sohaware/rpi/v0.7.5-checksum-repair/bootstrap/codynick-apps.sh "$APPS_SHA256"
bash "$temp/apps.sh"
